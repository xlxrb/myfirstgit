...
public:
    ...
    std::vector<ChatCommand> GetCommands() const override
    {
        ...
        static std::vector<ChatCommand> reloadCommandTable =
        {
            ...
            { "professional_trainer",                  SEC_ADMINISTRATOR, true,  &HandleReloadProfessionalTrainerCommand,                 "" },
            { "class_spells",                  SEC_ADMINISTRATOR, true,  &HandleReloadClassSpellsCommand,                 "" },
            { "teleport_points",                  SEC_ADMINISTRATOR, true,  &HandleReloadTeleportPointsCommand,                 "" },
            { "creature_kill_reward",                  SEC_ADMINISTRATOR, true,  &HandleReloadCreatureKillRewardCommand,                 "" },
            { "npc_vendor",                   SEC_ADMINISTRATOR, true,  &HandleReloadNpcVendorCommand,                  "" },
            { "professional_vendor",                   SEC_ADMINISTRATOR, true,  &HandleReloadProfessionalVendorCommand,                  "" },
            { "custom_vendor",                   SEC_ADMINISTRATOR, true,  &HandleReloadCustomVendorCommand,                  "" },
    ...
    static bool HandleReloadProfessionalTrainerCommand(ChatHandler* handler, const char* /*args*/)
    {
        sLog->outString("Re-Loading `t_professional_trainer` Table!");
        sObjectMgr->LoadProfessionalTrainerSpell();
        handler->SendGlobalGMSysMessage("DB table `t_professional_trainer` reloaded.");
        return true;
    }

    static bool HandleReloadClassSpellsCommand(ChatHandler* handler, const char* /*args*/)
    {
        sLog->outString("Re-Loading `t_class_spells` Table!");
        sObjectMgr->LoadClassSpells();
        handler->SendGlobalGMSysMessage("DB table `t_class_spells` reloaded.");
        return true;
    }

    static bool HandleReloadTeleportPointsCommand(ChatHandler* handler, const char* /*args*/)
    {
        sLog->outString("Re-Loading `t_teleport_points` Table!");
        sObjectMgr->LoadTeleportPoints();
        handler->SendGlobalGMSysMessage("DB table `t_teleport_points` reloaded.");
        return true;
    }

    static bool HandleReloadCreatureKillRewardCommand(ChatHandler* handler, const char* /*args*/)
    {
        sLog->outString("Re-Loading `t_creature_kill_reward` Table!");
        sObjectMgr->LoadCreatureKillReward();
        handler->SendGlobalGMSysMessage("DB table `t_creature_kill_reward` reloaded.");
        return true;
    }
    ...
    static bool HandleReloadProfessionalVendorCommand(ChatHandler* handler, const char* /*args*/)
    {
        sLog->outString("Re-Loading `t_professional_vendor` Table!");
        sObjectMgr->LoadProfessionalVendors();
        handler->SendGlobalGMSysMessage("DB table `t_professional_vendor` reloaded.");
        return true;
    }

    static bool HandleReloadCustomVendorCommand(ChatHandler* handler, const char* /*args*/)
    {
        sLog->outString("Re-Loading `t_custom_vendor` Table!");
        sObjectMgr->LoadCustomVendor();
        handler->SendGlobalGMSysMessage("DB table `t_custom_vendor` reloaded.");
        return true;
    }
