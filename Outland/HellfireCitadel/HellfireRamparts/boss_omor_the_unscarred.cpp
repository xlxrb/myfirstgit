...
enum Spells
{
    SPELL_SHADOW_BOLT           = 30686, //°µÓ°¼ý
    SPELL_SUMMON_FIENDISH_HOUND = 30707, //ÕÙ»½¾üÈ®
    SPELL_TREACHEROUS_AURA      = 30695, //±³ÅÑ¹â»·
    SPELL_DEMONIC_SHIELD        = 31901, //¶ñÄ§»¤¶Ü
    SPELL_ORBITAL_STRIKE        = 30637, //¹ìµÀ´ò»÷
    SPELL_SHADOW_WHIP           = 30638  //°µÓ°Ö®±Þ
};
